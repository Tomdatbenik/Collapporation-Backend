...
public class ProjectControllerTests {
    ...
    public void getProjectTest() throws Exception {
        mockMvc.perform(
                ...
                .andExpect(content().string(equalTo("{\"id\":\"0\",\"title\":\"project0\",\"smallDescription\":\"small description of project0\",\"status\":\"CONCEPT\",\"img\":\"aHR0cHM6Ly9waWNzdW0ucGhvdG9zLzUxMC8zMDA/cmFuZG9t\",\"owner\":0,\"created\":null}")));
    }
