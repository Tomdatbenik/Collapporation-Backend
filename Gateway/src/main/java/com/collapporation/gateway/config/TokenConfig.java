package com.collapporation.gateway.config;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.JWTVerifier;
import com.collapporation.gateway.utils.PemUtils;
...
public class TokenConfig {
    ...
    public JWTVerifier jwtVerifier(@Qualifier("publicAlgorithm") Algorithm algorithm){
        return JWT.require(algorithm).withIssuer(signer).acceptLeeway(1000 * 5).build();
    }
}
